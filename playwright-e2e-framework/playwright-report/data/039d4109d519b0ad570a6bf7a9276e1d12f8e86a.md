...
- Name: inventory.spec.js >> Dynamic UI Interactions - Product Inventory >> does not show a cart badge when the cart is empty @edge
- Location: tests\inventory.spec.js:71:3
